...
graph <- ggplot(df_cluster, aes(x = z_score_limited, y = variable)) +
  ...
  scale_color_identity() +
    ggtitle("Scores z des variables pour le cluster 5. Nicolas - Sportif Tout-terrain")
  
  # Enregistrer le graphique
  output_file <- file.path(output_dir, paste0("2021_5. Nicolas - Sportif Tout-terrain.png"))
