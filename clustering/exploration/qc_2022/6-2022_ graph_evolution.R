...
pred_centroid <- readRDS("_SharedFolder_datagotchi_federal_2024/clustering/data/2022_pred_centroid.rds")
...
data_long <- pred_centroid %>%
  pivot_longer(
    cols = c(CAQ, PQ, PLQ, QS, PCQ, Autre, NoVote),
    names_to = "party",
    values_to = "probability"
  )

# Chemin pour enregistrer les graphiques
output_dir <- "/home/alexab/Dropbox/Ulaval/CLESSN/datagotchi_federal_2024/_SharedFolder_datagotchi_federal_2024/clustering/graph/2022/réduit"
