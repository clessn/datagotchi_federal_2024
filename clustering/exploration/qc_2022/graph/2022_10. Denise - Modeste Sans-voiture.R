...
graph <- ggplot(df_cluster, aes(x = z_score_limited, y = variable)) +
  ...
  scale_color_identity() +
    ggtitle("Description du cluster 10. Denise - Modeste Sans-voiture (n=135)")
  
  # Enregistrer le graphique
  output_file <- file.path(output_dir, paste0("2022_10. Denise - Modeste Sans-voiture.png"))
