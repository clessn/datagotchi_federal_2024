...
graph <- ggplot(df_cluster, aes(x = z_score_limited, y = variable)) +
  ...
  scale_color_identity() +
    ggtitle("Description du cluster 11. Gabriel - Urbain Raffiné (n=68)")
  
  # Enregistrer le graphique
  output_file <- file.path(output_dir, paste0("2022_11. Gabriel - Urbain Raffiné.png"))
