...
plot_cluster6 <- ggplot(data_cluster6, aes(x = day, y = probability, color = party)) +
  ...
  labs(
    title = "Probabilité des partis pour le cluster 6. Charlie - Urbain.e Queer",
    x = "Jour",
    y = "Probabilité",
    color = "Parti"
  ) +
...
ggsave(
  filename = paste0(output_dir, "/2022_evolution_cluster6.png"),
  plot = plot_cluster6,
  width = 12,
  height = 8
)
