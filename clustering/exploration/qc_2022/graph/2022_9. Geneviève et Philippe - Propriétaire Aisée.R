...
graph <- ggplot(df_cluster, aes(x = z_score_limited, y = variable)) +
  ...
  scale_color_identity() +
    ggtitle("Description du cluster 9. Geneviève et Philippe - Propriétaire Aisée (n=208)")
  
  # Enregistrer le graphique
  output_file <- file.path(output_dir, paste0("2022_9. Geneviève et Philippe - Propriétaire Aisée.png"))
