...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\titlepagefont\fontsize{26pt}{16pt}\selectfont \textbf{Centre d'analyse des politiques publiques (CAPP)}}\\[1cm]
    {\titlepagefont\fontsize{26pt}{16pt}\selectfont \textbf{CLESSN}}\\[1cm]
    {\titlepagefont\fontsize{16pt}{16pt}\selectfont \textbf{Université Laval}}\\[1cm]
