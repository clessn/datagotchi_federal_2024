...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\titlepagefont\fontsize{22pt}{18pt}\selectfont \textbf{Rapport sur Café Transport}}\\[1cm]
    \includegraphics[width=0.2\textwidth]{img/leger_small.png}\\[4cm]
    {\titlepagefont\fontsize{16pt}{16pt}\selectfont \textbf{Centre d'analyse des politiques publiques (CAPP)}}\\
    ...
    {\titlepagefont\fontsize{16pt}{16pt}\selectfont \textbf{Université Laval}}\\
