...
# ------------------------------------------------------------------------
# Données pilote
DataPilot <- readRDS("/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/pilote/dataClean/_previous/datagotchi2025_canada_pilot_20250310.rds")

# Données de l'application
DataApp <- readRDS("/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/app/dataClean/_previous/datagotchi2025_canada_app_20250314.rds")

# Chargement des prédictions par RTA
rta_predictions <- read.csv("/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/rta_predictions_partis_previous.csv",
                          stringsAsFactors = FALSE)

# Chargement des résultats d'entraînement précédents pour obtenir les vraies variables du modèle original
results_train <- readRDS("/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/_previous/resultsTrainV4_31janvier2025.rds")
previous_model <- readRDS("/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/_previous/finalmodel_withOutInteractions.rds")
...
model_final <- readRDS("/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/finalmodel_withRTAPredictions_2025-04-15.rds")
dummies_final <- readRDS("/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/dummies_finalmodel_withRTAPredictions_2025-04-15.rds")
...
pdf("/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/model_evaluation_plots.pdf", width = 12, height = 10)
print((p1 | p2) / (p3 | p4))
dev.off()
...
write.csv(global_metrics, "/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/global_metrics.csv", row.names = FALSE)
write.csv(party_metrics, "/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/party_metrics.csv", row.names = FALSE)
write.csv(region_metrics, "/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/region_metrics.csv", row.names = FALSE)
write.csv(error_summary, "/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/error_summary.csv", row.names = FALSE)
write.csv(region_robust_metrics, "/home/etienne_prx/Dropbox/Travail/CLESSN/Projets/datagotchi_canada_2025/_SharedFolder_datagotchi_federal_2024/data/modele/region_robust_metrics.csv", row.names = FALSE)
