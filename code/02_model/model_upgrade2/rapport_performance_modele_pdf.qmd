---
title: "Rapport de performance du modèle ACTUEL de prédiction électorale"
...
# Utiliser kable standard au lieu de kableExtra
kable(global_metrics_df, format = "latex", caption = "Métriques globales de performance du modèle", booktabs = TRUE)
```
...
party_data <- data.frame(
  ...
  party_name = c("Bloc Québécois", "Conservateur", "Libéral", "NPD", "Vert"),
...
# Création du tableau avec kable standard
...
region_data <- data.frame(
  ...
  region_name = c("Québec", "Prairies", "Ontario", "Colombie-Britannique", "Atlantique", "Territoires"),
...
error_data <- data.frame(
  ...
  error_description = c(
    "Libéral prédit comme Bloc Québécois",
    "Libéral prédit comme Conservateur",
    "Conservateur prédit comme Libéral",
    "Conservateur prédit comme Bloc Québécois",
    "NPD prédit comme Conservateur",
    "NPD prédit comme Bloc Québécois",
    "NPD prédit comme Libéral",
    "Libéral prédit comme NPD",
    "Conservateur prédit comme NPD",
    "Bloc Québécois prédit comme Libéral"
  ),
...
# Création du tableau avec kable standard
kable(error_data %>% head(6) %>% select(error_description, n, percentage) %>%
        rename("Type d'erreur" = error_description, 
               "Nombre de cas" = n,
               "Pourcentage des erreurs (%)" = percentage), 
      format = "latex", 
      caption = "Les 6 principaux types d'erreurs du modèle",
      booktabs = TRUE)
```
...
region_robust_data <- data.frame(
  ...
  region_name = c("Atlantique", "Prairies", "Ontario", "Québec", "Colombie-Britannique", "Territoires"),
